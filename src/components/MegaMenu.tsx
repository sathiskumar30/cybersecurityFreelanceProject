...
export const MegaMenu: React.FC<MegaMenuProps> = ({ isActive, items }) => {
  return (
    <div className="absolute top-full left-0 w-screen bg-card/95 backdrop-blur-lg border-t border-border shadow-lg z-50" style={{ height: '50vh' }}>
